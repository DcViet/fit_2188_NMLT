...
namespace _21880291
{
    ...
    internal class Program
    {
        ...
        static void HienThiThongTinLoaiHang(LoaiMatHang lMH)
        {
            ...
            Console.WriteLine("Ten mat hang: {0}", lMH.TenLoai);
        }
        ...
        static void ThemMatHang(ref MatHang[] danhSachMatHang, LoaiMatHang[] danhSachLoaiHang)
        {
            ...
            // Neu loai hang khong ton tai thi yeu cau user them loai truoc
            ...
            // Tao mat hang moi (da co loai hang)
            ...
            Console.WriteLine("Da them mat hang thanh cong");
        }
        ...
        static void TimKiemLoai(LoaiMatHang[] danhSachLoaiHang)
        {
            ...
            {
                Console.WriteLine("Mat hang ten {0} co thong tin nhu sau:", tenTim);
                HienThiThongTinLoaiHang(loaiHangTim);
            }
            else
            {
                Console.WriteLine("Khong tim thay mat hang co ten {0}", tenTim);
            }
        }
        ...
        static void Main(string[] args)
        {
            ...
            do 
            {
                ...
                Console.WriteLine("6. Chinh sua loai hang");
